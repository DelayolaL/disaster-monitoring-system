...
<div class="container-xl">
      <div class="table-title">
        <div class="row">
          <div class="col-sm-12">
            <center>
            <h2 style="color: white;">Disaster <b>Updated!</b></h2>
            </center>
          </div>
        </div>
      </div>
      <center>
      <button type="button" onclick="location.replace('disaster.php')" class="btn btn-default btn-lg">Return</button>
      </center>    
</div>
<?php
  }
  ...
  $sql_query = "DELETE FROM disaster WHERE `disaster`.`Disaster_ID` = '$theID';";
...
$recentact = "Disaster [".$DisasterName."] Has Been Deleted";
...
<div class="container-xl">
      <div class="table-title">
        <div class="row">
          <div class="col-sm-12">
            <center>
            <h2 style="color: white;">Disaster <b>Deleted!</b></h2>
            </center>
          </div>
        </div>
      </div>
