...
if ($_SERVER['REQUEST_METHOD'] == 'POST'){
  ...
  $theID = $_POST['Update'];
  $upevacsite = $_POST['upevacsite'];
  $upDuring = $_POST['upDuring'];
  $upDate = $_POST['upDate'];
  $upHouseCond = $_POST['upHouseCond'];
...
<div class="container-xl">
      ...
      <center>
      <button type="button" onclick="location.replace('damages.php')" class="btn btn-default btn-lg">Return</button>
      </center>    
</div>
<?php
  }
  ...
  elseif (isset($_POST['Delete'])) {
    ...
    $sql = "SELECT * FROM `damages` WHERE `damages`.`damage_ID` = '$theID';";
    ...
    while ($row = $result->fetch_assoc()) {
      $familyserial = $row["Serial_No."];
    }


    $sql_query = "DELETE FROM damages WHERE `damages`.`damage_ID` = '$theID';";
    if (mysqli_query($conn, $sql_query)) {
?>
<div class="container-xl">
      <div class="table-title">
...
<?php
  $sql_query = "UPDATE `family` SET `Damage_Rec` = 'No' WHERE `family`.`Serial_No.` = '$familyserial';";
