...
<div class="container-xl">
      <div class="table-responsive">
        <div class="table-wrapper">
          ...
          <form method="post" action="barangay-edit-action-test.php" onsubmit="return validateForm()">
          <table id="familytable" class="table table-bordered" style="margin-left: 0px;">
              <thead>
                <tr>

                  <th style="text-align: center; vertical-align: middle; background-color: #435d7d; color: white;">No.</th>
                  <th style="text-align: center; vertical-align: middle; background-color: #435d7d; color: white;">Barangay Name</th>
                  <th style="text-align: center; vertical-align: middle; background-color: #435d7d; color: white;">Chairman</th>
                  <th style="text-align: center; vertical-align: middle; background-color: #435d7d; color: white;">Contact No.</th>
                </tr>
              </thead> 
                <tbody>
                 
                  <?php
                  $sql = "SELECT * FROM `barangay` WHERE `Barangay_ID` = '$brgyID';";
                ...
                ?>
                                ...
                                <tr>
                                  <td style="background-color: #ADADAD;">Cannot be Edited</td>
                                  <td style="background-color: #ADADAD;">Cannot be Edited</td>
                                  <td style="background-color: #ADADAD;"><input type="text" name="upCap" style="width: 150px;" value=""></td>
                                  <td style="background-color: #ADADAD;">
                                    <input type="text" id='updateNo' name="upNo" style="width: 150px;" oninput="validateContactNo(this)" value="">
                                  </td>
                                </tr>
                              </tbody>
                          </table>
      ...
      <center>
        <div class="buttons">
          <button type="button" onclick="location.replace('barangay.php')" class="btn btn-default">Return</button>
          <button id="submitBtn" type="button" name="Update" value="<?php echo $theID; ?>" class="btn btn-primary">Update</button>
        </div>
        </center>
          </form>
...
<script>
  document.getElementById('submitBtn').addEventListener('click', function() {
    ...
    var theIDValue = document.getElementById('submitBtn').value;
