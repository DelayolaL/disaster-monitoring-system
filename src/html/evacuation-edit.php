...
<div class="container-xl">
          ...
          <table id="familytable" class="table table-bordered" style="margin-left: 0px;">
              <thead>
                <tr>
                  ...
                  <th style="text-align: center; vertical-align: middle; background-color: #435d7d; color: white;">Address</th>
                ...
                <tbody>
                  <tr>
                  <?php
                  $sql = "SELECT * FROM `evac_center` WHERE `Evac_ID` = '$evacID';";
                  ...
                  echo "
                    ...
                    <td style='vertical-align: middle;'  class='truncate-text'>" . $row["Address"] . "</td>
                    ";
                }
                ?>
                  </tr>
                  <tr>
                    <td style="background-color: #ADADAD;"><input type="text" name="upEvac" style="width: 150px;" value=""></td>
                    <td style="background-color: #ADADAD;"><input type="text" name="upAdd" style="width: 150px;" value=""></td>
                  </tr>
                </tbody>
            </table>
      ...
      <center>
        <div class="buttons">
          <button type="button" onclick="location.replace('evacuation.php')" class="btn btn-default">Return</button>
        ...
        <div class="table-wrapper">
          <div class="table-title">
            <div class="row">
              <div class="col-sm-12">
                <center>
                <h2>Delete <b>Evacuation Center?</b></h2>
                </center>
              </div>
            </div>
          </div>
