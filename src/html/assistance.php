...
<h3 class="center">FAMILY ASSISTANCE RECORD</h3>
      ...
      $sql = "INSERT INTO `damages` (`damage_ID`, `Serial_No.`, `Date`, `Housing_Condition`, `Casualty`) VALUES (NULL, '$serialindex', '$asstdate', '$damages', '$casualty');";

      if (mysqli_query($conn, $sql)){
        echo "<h3 class=\"center\">Recorded Successfully!</h3>
        <div class=\"button-container\">
          <button onclick=\"window.location.replace('ui-card.php')\" class=\"colored-button\" type=\"button\">Return</button>
        </div>
      ";
      }
      else
...
?>
<form method="post" action="assistance-action.php">
<h3 class="center">FAMILY ASSISTANCE RECORD</h3>
  <div class="account-details">
    <div>
      <div class="container">
    <!-- <label>Assistance during</label>
    <input type="date" name="asstdate" required> -->
  </div>
  <table id="familytable" class="fl-table">
    <thead>
      <tr>
        ...
        <!-- <th>Family Head Firstname</th>
        <th>Family Head Lastname</th> -->
    ...
    <tbody id="data-table">
        <?php
          $sql = "SELECT * FROM `family` ORDER BY `family`.`Date_Registered` DESC";
            ...
            $cellindex = $cellindex + 1;
              echo "
                <tr>
                    ...
                    <td>
                      <button type=\"submit\" class=\"btn btn-primary\" name='View' onclick=\"dothis('" . $row["Serial_No."] . "', '" . $row["Family_Name"] . "')\" value='" . $row["Serial_No."] . "'>Select</button>
                    </td>
                </tr>";
            }
        ?>
  ...
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-md-6">
          ...
          <input id="serialindex" type="text" name="serialindex" style="display: none;" readonly required>
