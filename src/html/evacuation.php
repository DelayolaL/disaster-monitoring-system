...
<head>
  ...
  <div id="modalbody">
    <section class="box">
    <div id="themodal" class="container-fluid">
      <div class="card">
        <div class="card-body">
    <form method="post" action="evacuation-edit.php">
    <div class="close">&times;</div>

    <div class="evacuation-box">
      <div>
        <input id="Evacname" type="text" name="Evacname" class="form-control" required>
        <label for="Evacname">Evacuation Center:</label>
      </div>
      <div>
        <input id="Address" type="text" name="Evacaddress" class="form-control" required>
        <label for="Address">Address:</label>
      </div>
    </div>
    <button class="colored-button" type="submit" name="Add">Add</button>
        </form>
      </div>
...
<h3 class="center">Evacuation Centers</h3>
    ...
    <tbody id="data-table">
        ...
        <?php
          ...
          while ($row = $result->fetch_assoc()) {
              ...
              echo "
                <tr data-row-id='" . $row["Evac_ID"] . "'>
                    <td class='edit-btn-container' style='vertical-align: middle;'>
                      <button type=\"button\" class=\"btn btn-primary btn-sm edit-btn\" data-toggle=\"modal\" name='Update'  value='" . $row["Evac_ID"] . "'><i class=\"material-icons\" data-toggle=\"tooltip\" title=\"Edit\">&#xE254;</i></button>
                      ...
                      // Linked to evacuation-action.php

                      echo"
                    </td>
                    <td style='vertical-align: middle;'>" . $row["Evac_ID"] . "</td>
                    <td class='chairman-cell' style='vertical-align: middle;'>" . $row["Evac_Center_Name"] . "</td>
                    <td class='contact-no-cell' style='vertical-align: middle;'>" . $row["Address"] . "</td> 
  ...
  <center>
  <button class="colored-button" type="submit" name="addevac">Add</button>
  </center>
</form>
...
$('#data-table').on('click', '.btn-primary', function () {
  ...
  // Create input fields with current values
    ...
    var contactNoInput = $('<input type="text" name="upAdd" class="form-control" value="' + contactNoCell.text() + '">');
...
var checkButton = $('<button>', {
  ...
  click: function () {
    ...
    fetch('evacuation-action-json.php', {
      method: 'POST',
      body: formData
    })
