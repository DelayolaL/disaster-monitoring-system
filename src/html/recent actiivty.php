        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item selected">
              <a class="sidebar-link active" href="recent actiivty.php" aria-expanded="false">
                <span>
            ...
            <div class="card w-100">
              <div class="card-body p-4">
                ...
                <ul class="timeline-widget mb-0 position-relative mb-n5">
                  <?php 
                  $sql = "SELECT * FROM `recent activity` ORDER BY `Created_On` DESC LIMIT 20;";
                  ...
                  if (mysqli_num_rows($result) <= 0) {
                    ...
                    <div class="timeline-desc fs-3 text-dark mt-n1">'.$row['Activity'].' <b>by ['.$row['Account_Used'].']</b></div>
                  </li>';
                    }
                  }
                ?>
