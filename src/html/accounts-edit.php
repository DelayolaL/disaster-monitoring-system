        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item selected">
              <a class="sidebar-link active" href="./accounts.php" aria-expanded="false">
                <span>
...
<div class="container-xl">
      <div class="table-responsive">
        <div class="table-wrapper">
          ...
          <form method="post" action="accounts-edit-action.php">
          <table id="familytable" class="table table-bordered" style="margin-left: 0px;">
              <thead>
                <tr>

                  <th style="text-align: center; vertical-align: middle; background-color: #435d7d; color: white;">Username</th>
                  <th style="text-align: center; vertical-align: middle; background-color: #435d7d; color: white;">Password</th>
                  <th style="text-align: center; vertical-align: middle; background-color: #435d7d; color: white;">Email</th>
                  <th style="text-align: center; vertical-align: middle; background-color: #435d7d; color: white;">Priviledge</th>
                </tr>
              </thead> 
                <tbody>
                  <tr>
                  ...
                  while ($row = $result->fetch_assoc()) {
                    $theID = $row["Account_ID"];

                    $encrypt = $row["Password"];
                    $hashed = password_hash($encrypt, PASSWORD_DEFAULT);

                  echo "
                    <td style='vertical-align: middle;'>" . $row["Username"] . "</td>
                    <td style='vertical-align: middle;'  class='truncate-text'>" . $hashed . "</td>
                    <td style='vertical-align: middle;'>" . $row["Email"] . "</td>                    
                    <td style='vertical-align: middle;'>" . $row["Priviledge"] . "</td>
                    ";
                }
                ?>
                  </tr>
                                <tr>
                                  <td style="background-color: #ADADAD;"><input type="text" name="upUsername" style="width: 150px;" value=""></td>
                                  <td style="background-color: #ADADAD;"><input type="password" name="upPass" style="width: 150px;" value=""></td>
                                  <td style="background-color: #ADADAD;"><input type="text" name="upEmail" style="width: 150px;" value=""></td>
      ...
      <center>
        <div class="buttons">
          <button type="button" onclick="location.replace('accounts.php')" class="btn btn-default">Return</button>
