...
<div class="container-xl">
        ...
        <div class="table-wrapper">
          <div class="table-title">
            <div class="row">
              <div class="col-sm-12">
                <center>
                <h2>Edit <b>Relief Distribution Record</b></h2>
                </center>
              </div>
            </div>
          </div>
          ...
          <form method="post" action="relief-records-edit-action.php">
          <table id="familytable" class="table table-bordered" style="margin-left: 0px;">
              <thead>
                <tr>

                  <th style="text-align: center; vertical-align: middle; background-color: #435d7d; color: white;">Relief Goods</th>
                  <th style="text-align: center; vertical-align: middle; background-color: #435d7d; color: white;">Quantity</th>
                  <th style="text-align: center; vertical-align: middle; background-color: #435d7d; color: white;">Received By</th>
                  <th style="text-align: center; vertical-align: middle; background-color: #435d7d; color: white;">Cash Assistance</th>
                  <th style="text-align: center; vertical-align: middle; background-color: #435d7d; color: white;">Provider</th>
                </tr>
              </thead> 
                <tbody>
                  <tr>
                  <?php
                  $sql = "SELECT * FROM `relief_distribution` INNER JOIN `family` ON `relief_distribution`.`Serial_No.` = `family`.`Serial_No.` WHERE `rd_ID` = '$rdID';";
                  ...
                  echo "
                    ...
                    <td style='vertical-align: middle;'>" . $row["Rec_Fam_Member"] . "</td>                    
                ...
                ?>
                  ...
                  <tr>
                    <td>
                      ...
                      <br>
                      <input id="paymentInput" type="text" name="upKind" style="width: 150px;" value="">
                    </td>
                    <td><input type="number" name="upQuant" style="width: 150px;" value=""></td>
                    <td>
                      <select name="upRecieve">
                    ...
                    <td><input id="cashInput" type="number" name="upCost" style="width: 150px;" value="0" readonly></td>
                    <td>
                      <select name="upProvider">
                        <option value="">Choose One...</option>
                        <?php
                        $sql = "SELECT * FROM `accounts` WHERE `Priviledge` != 'Unapproved';";
                        $result = $conn->query($sql);
      ...
      <center>
        <div class="buttons">
          <button type="button" onclick="location.replace('relief-records.php')" class="btn btn-default">Return</button>
          <button type="submit" name="Update" value="<?php echo $rdID; ?>" class="btn btn-primary">Update</button>
        </div>
        </center>
          </form>
</div>
<script>
    function updateInput(radio) {
      var inputField = document.getElementById("paymentInput");
      var cashField = document.getElementById("cashInput");
...
<div class="container-xl">
        ...
        <div class="table-wrapper">
          <div class="table-title">
            <div class="row">
              <div class="col-sm-12">
                <center>
                <h2>Delete <b>Relief Distribution Record?</b></h2>
                </center>
              </div>
            </div>
          </div>
      ...
      <center>
        <div class="buttons">
          <button type="button" onclick="location.replace('relief-records.php')" class="btn btn-default">Return</button>
          <button type="submit" name="Delete" value="<?php echo $rdID; ?>" class="btn btn-danger">Delete</button>
        </div>
        </center>
          </form>
</div>
