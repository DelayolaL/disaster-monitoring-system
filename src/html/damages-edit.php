...
<div class="container-xl">
      <div class="table-responsive">
        <div class="table-wrapper">
          ...
          <form method="post" action="damages-edit-action.php">
          <table id="familytable" class="table table-bordered" style="margin-left: 0px;">
              <thead>
                <tr>

                  <th style="text-align: center; vertical-align: middle; background-color: #435d7d; color: white;">Evacuated to</th>
                  <th style="text-align: center; vertical-align: middle; background-color: #435d7d; color: white;">During</th>
                  <th style="text-align: center; vertical-align: middle; background-color: #435d7d; color: white;">Date</th>
                  <th style="text-align: center; vertical-align: middle; background-color: #435d7d; color: white;">Housing Condition</th>
                </tr>
              </thead> 
                <tbody>
                  <tr>
                  <?php
                  $sql = "SELECT * FROM `damages` WHERE `damage_ID` = '$damageID';";
                  ...
                  while ($row = $result->fetch_assoc()) {
                    ...
                    $evacID = $row["Evac_Cent_ID"];
                    $evacsql = "SELECT * FROM `evac_center` WHERE `Evac_ID` = '$evacID';";
                    $evacres = $conn->query($evacsql);
                    while ($evacrow = $evacres->fetch_assoc()) {
                      $evacname = $evacrow['Evac_Center_Name'];
                    }

                  echo "
                    <td style='vertical-align: middle;'>" . $evacname . "</td>
                ...
                ?>
                                ...
                                <tr>
                                  ...
                                  <td style="background-color: #ADADAD;"><input type="text" name="upDuring" style="width: 150px;" value=""></td>
                                  <td style="background-color: #ADADAD;"><input type="date" name="upDate" style="width: 150px;" value=""></td>
                                  <td style="background-color: #ADADAD;">
                                    <select style="width: 100%;"  id="damages" name="upHouseCond" required>
                                    <option value="">Choose One...</option>
      ...
      <center>
        <div class="buttons">
          <button type="button" onclick="location.replace('damages.php')" class="btn btn-default">Return</button>
        ...
        <div class="table-wrapper">
          <div class="table-title">
            <div class="row">
              <div class="col-sm-12">
                <center>
                <h2>Delete <b>Damage Record?</b></h2>
                </center>
              </div>
            </div>
          </div>
