...
<div class="container-xl">
      <div class="table-title">
        <div class="row">
          <div class="col-sm-12">
            <center>
            <h2 style="color: white;">Evacuation Center <b>Updated!</b></h2>
            </center>
          </div>
        </div>
      </div>
      <center>
      <button type="button" onclick="location.replace('evacuation.php')" class="btn btn-default btn-lg">Return</button>
      </center>    
</div>
<?php
  }
  ...
  elseif (isset($_POST['Delete'])) {
   ...
   if ($result) {
    ...
    if ($row) {
        ...
        // Now $evacCenterName contains the value you want
        echo "Evacuation Center Name: " . $evacCenterName;
    } else {
        // No row found for the specified Evac_ID
        echo "No evacuation center found for the specified ID";
    }
  ...
  $sql_query = "DELETE FROM `evac_center` WHERE `evac_center`.`Evac_ID` = '$theID'";
...
$recentact = "Evacuation Center [".$evacCenterName."] Has Been Deleted";
...
<div class="container-xl">
      <div class="table-title">
        <div class="row">
          <div class="col-sm-12">
            <center>
            <h2 style="color: white;">Evacuation Center <b>Deleted!</b></h2>
            </center>
          </div>
        </div>
      </div>
...
<?php
  ...
  elseif (isset($_POST['Add'])) {
    ...
    $Evacaddress= $_POST['Evacaddress'];

    $sql_query = "INSERT INTO `evac_center` (`Evac_ID`, `Evac_Center_Name`, `Address`) VALUES (NULL, '$Evacname', '$Evacaddress');";
    if (mysqli_query($conn, $sql_query)){
      echo '<div class="container-xl">
                  <div class="table-title">
                    <div class="row">
                      <div class="col-sm-12">
                        <center>
                        <h2 style="color: white;">Evacuation Center <b>Recorded!</b></h2>
                        </center>
                      </div>
                    </div>
                  </div>
      ...
      echo "<script>
            window.alert('Error: " . $sql . mysqli_error($conn) . "');
