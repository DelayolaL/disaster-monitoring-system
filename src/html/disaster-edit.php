...
<div class="container-xl">
        ...
        <div class="table-wrapper">
          <div class="table-title">
            <div class="row">
              <div class="col-sm-12">
                <center>
                <h2>Edit <b>Evacuation Center</b></h2>
                </center>
              </div>
            </div>
          </div>
          ...
          <form method="post" action="disaster-action.php">
          <table id="familytable" class="table table-bordered" style="margin-left: 0px;">
              <thead>
                <tr>

                  <th style="text-align: center; vertical-align: middle; background-color: #435d7d; color: white;">Disaster</th>
                  <th style="text-align: center; vertical-align: middle; background-color: #435d7d; color: white;">Occured</th>
                ...
                <tbody>
                  <tr>
                  <?php
                  $sql = "SELECT * FROM `disaster` WHERE `Disaster_ID` = '$PostID';";
                  ...
                  while ($row = $result->fetch_assoc()) {
                    $theID = $row["Disaster_ID"];

                  echo "
                    <td style='vertical-align: middle;'>" . $row["Disaster"] . "</td>
                    <td style='vertical-align: middle;'  class='truncate-text'>" . $row["Occurred"] . "</td>
                    ";
                }
                ?>
                  </tr>
                  <tr>
                    <td style="background-color: #ADADAD;"><input type="text" name="upDis" style="width: 150px;" value=""></td>
                    <td style="background-color: #ADADAD;"><input type="date" name="upOccur" style="width: 150px;" value=""></td>
                  </tr>
                </tbody>
            </table>
      ...
      <center>
        <div class="buttons">
          <button type="button" onclick="location.replace('disaster.php')" class="btn btn-default">Return</button>
...
<?php
  ...
  window.location.replace('disaster.php');
  </script>";
  }
}
else{
