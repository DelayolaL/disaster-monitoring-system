...
if (isset($_POST['Add'])) {
    ...
    $sql_query = "INSERT INTO `barangay` (`Barangay_ID`, `Barangay_Name`, `Barangay_Chairman`, `Contact_Number`) VALUES (NULL, '$barangay', '$chair', '$kontak');";
    
    if (mysqli_query($conn, $sql_query)){
        echo "<script>
          window.alert(\"Barangay Recorded!\");
