...
<form method="post" action="masterlist-generate.php">
  ...
  <table id="masterlist" class="fl-table">
    ...
    <tbody id="data-table">
        ...
        function formatDate($dateString) {
            ...
            $formattedDate = ucfirst(strtolower($formattedDate)); // Capitalize the first letter of each word
            ...
            $formattedDate = formatDate($originalDate);
              ...
              echo "
                <tr>
                    ...
                    <td>
                      <button type=\"submit\" class=\"btn btn-primary\" name='View' value='" . $row["Disaster_ID"] . "'>Select</button>
                    </td>
                </tr>";
            }
        ?>
    ...
    <!-- <form method="post" target="_blank" action="getcsv.php">
      <center>
        <button type="submit" class="btn btn-primary">Generate Masterlist</button>
      </center>
    </form>
 -->  </div>
</div>
