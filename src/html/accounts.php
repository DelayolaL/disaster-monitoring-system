...
<h3 class="center">REGISTERED ACCOUNTS</h3>
  ...
  <table id="registeredtable" class="fl-table">
    <thead>
      <tr>
        ...
        <th style="text-align: center; vertical-align: middle;">Privilege</th>
      </tr>
    </thead>
    <tbody id="data-table">
        <?php
              ...
              echo "
                <tr>
                    ...
                    if ($accountID != 1) {
                      ...
                      echo "
                      <button type=\"submit\" class=\"btn btn-primary btn-sm\" data-toggle=\"modal\" name='Edit' value='" . $row["Account_ID"] . "'><i class=\"material-icons\" data-toggle=\"tooltip\" title=\"Edit\">&#xE254;</i></button>
                      <button type=\"submit\" class=\"btn btn-danger btn-sm\" data-toggle=\"modal\" name='Delete' value='" . $row["Account_ID"] . "'><i class=\"material-icons\" data-toggle=\"tooltip\" title=\"Delete\">&#xE872;</i></button>";

                    }
                    echo "
                    </td>
                    <td style='vertical-align: middle;'>" . $row["Account_ID"] . "</td>
...
<form method="post" action="accounts-edit.php">
<h3 class="center">UNREGISTERED ACCOUNTS</h3>
  <div class="account-details">
    <div>
      <div class="container">
  </div>
  <table id="unregisteredtable"class="fl-table">
    <thead>
      <tr>
        <th style="text-align: center; vertical-align: middle;">Action</th>
        <th style="text-align: center; vertical-align: middle;">Account No.</th>
        ...
        <th style="text-align: center; vertical-align: middle;">Email</th>
        <th style="text-align: center; vertical-align: middle;">Password</th>
        <th style="text-align: center; vertical-align: middle;">Priviledge</th>
      </tr>
    </thead>
    <tbody id="data-table">
        <?php
  ...
  <center>
    <button type="button" class="btn btn-primary" onclick="window.location.replace('authentication-register.php')">Add</button>
  </center>
</form>
        </div>
      </div>
